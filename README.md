...
This repository contains a lightweight, custom telemetry protocol library written in C. It is designed for embedded systems, UAVs (Unmanned Aerial Vehicles), and ground control stations to communicate efficiently and reliably over serial, UDP, or other data links.xxssllaasaaaksk
a
## Key Features
